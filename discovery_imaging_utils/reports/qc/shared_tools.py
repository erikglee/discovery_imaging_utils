...
def _construct_structural_html(report_path):
    ...
    with open(structural_html_path, 'w') as temp_html:
        ...
        temp_html.write('<p> </p>')
        temp_html.write('<img src="../structural_qc/fs_segmentation.jpeg" alt="fs segmentation">\n')
        temp_html.write('<h2>Segmentation of GM/WM/CSF for Nuisance Regression</h2>\n')
        temp_html.write('<p> </p>')
        temp_html.write('<img src="../structural_qc/t1_regressors.jpg" alt="t1 regressor ROIs">\n')
