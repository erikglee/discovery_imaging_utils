...
def populate_dict_for_denoising(file_path_dictionary, TR, normalize = True):
	...
	dict_for_denoising['image_data_dictionary'] = populate_image_data_dictionary(lh_gii_data_path=lh_gii_data_path,
...
def populate_image_data_dictionary(lh_gii_data_path=None,
									lh_inclusion_mask_path=None,
									lh_parcellation_path=None,
									rh_gii_data_path=None,
									rh_inclusion_mask_path=None,
